<h2><a href="https://www.geeksforgeeks.org/problems/count-pairs-odd-xor0308/1?page=2&category=Arrays&difficulty=School,Basic&status=unsolved&sortBy=accuracy">Count Pairs Odd Xor</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an array <strong>arr[]</strong> of <strong>N</strong> integers, the task is to find the number of pairs in the array whose XOR is odd.</span></p>
